...
def parse_article(link, refresh_time=600):
    ...
    if os.path.exists(finished_file) and os.path.getmtime(path) + refresh_time * 1000 > time.time():
    ...
    subprocess.check_call(["node", "parse_article.js", html_path])
